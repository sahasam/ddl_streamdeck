...
/**
 */
@action({ UUID: "com.casildo-romero.daedaelus-chiplet-demo.round-trip-latency" })
export class RoundTripLatency extends SingletonAction {

	constructor() {
		super();
	}

	override onWillAppear(ev: WillAppearEvent<RounddTripLatencySettings>): Promise<void> | void {
...
type RounddTripLatencySettings = {
	columnIndex: number;
	keyIndex: number;
};
