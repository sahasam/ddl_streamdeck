...
/**
 */
@action({ UUID: "com.casildo-romero.daedaelus-chiplet-demo.packets-per-second" })
export class PacketsPerSecond extends SingletonAction {

	constructor() {
		super();
	}

	override onWillAppear(ev: WillAppearEvent<PacketsPerSecondSettings>): Promise<void> | void {
